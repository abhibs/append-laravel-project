        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-4 offset-6">
                    <a class="btn btn-danger" href="{{ route('invoice-download', $data->id) }}">Invoice Download</a>
                </div>
            </div>
            <div class="row">
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($data->updated_at)->format('d F Y') }}</td>
                            </tr>
                            <tr>
                                <td>Order Amount</td>
                                <td>{{ $data->payable_price }} Rs.</td>
                            </tr>
