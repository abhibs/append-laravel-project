                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('team-update', $data->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="designation" class="form-control" type="text"
                                            id="example-text-input" value="{{ $data->designation }}">
                                    ...
                                    @foreach ($socialmedia as $media)
                                        <div class="col-sm-5 mb-3">
                                            <input name="icon[]" class="form-control" type="text"
                                                id="example-text-input" placeholder="Enter Social Media Icon Class"
                                                value="{{ $media->icon }}">
                                        ...
                                        <div class="col-sm-5 mb-3">
                                            <input name="url[]" class="form-control" type="text"
                                                id="example-text-input" placeholder="Enter Social Media URL"
                                                value={{ $media->url }}>
                                        </div>
                                ...
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Team">
